...
function openPopup(id) {
  ...
  if (el) el.style.display = "flex"; // Changed from "block" to "flex" to properly center modals
}
...
if (supportBtn) {
  supportBtn.onclick = function () {
    window.open("https://www.instagram.com/beingprachi_/", "_blank");
  };
}
